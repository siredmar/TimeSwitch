...
// *********************************************************************
  ...
  unsigned int ThresholdWatts = 0;
  unsigned int ThresholdTime = 0;
  unsigned int AdcCalib = 0;
// *********************************************************************
// LCDML MENU/DISP
// *********************************************************************
  // create menu
  ...
  LCDML_DISP_add      (0  , _LCDML_G1  , LCDML_root        , 1  , "Main view"         , LCDML_FUNC_mainView);
  LCDML_DISP_add      (1  , _LCDML_G1  , LCDML_root        , 2  , "Settings"          , LCDML_FUNC);
  LCDML_DISP_add      (2  , _LCDML_G1  , LCDML_root_2      , 1  , "Threshold [W]"      , LCDML_FUNC_threshold_w);
  LCDML_DISP_add      (3  , _LCDML_G1  , LCDML_root_2      , 2  , "Threshold [min]"         , LCDML_FUNC_threshold_t);
  LCDML_DISP_add      (4  , _LCDML_G1  , LCDML_root_2      , 3  , "Calibration"         , LCDML_FUNC_calibration);
  LCDML_DISP_add      (5  , _LCDML_G1  , LCDML_root_2      , 4  , "Test"         , LCDML_FUNC_test);
