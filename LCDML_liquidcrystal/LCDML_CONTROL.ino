...
// settings
  ...
  #define _LCDML_CONTROL_digital_enter           5    
  #define _LCDML_CONTROL_digital_up              2
  #define _LCDML_CONTROL_digital_down            3
  #define _LCDML_CONTROL_digital_quit            4
  #define _LCDML_CONTROL_digital_left            1
  #define _LCDML_CONTROL_digital_right           1
// *********************************************************************
// setup
void LCDML_CONTROL_setup()
{
